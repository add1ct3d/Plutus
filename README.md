...
It takes `0.0033485658` seconds for this progam to brute force a __single__ Bitcoin address. 

However, through `multiprocessing.Pool()` a concurrent process is created for every CPU your computer has. So this program can brute force addresses at a speed of `0.0033485658 ÷ cpu_count()` seconds.
...
- [X] Store the database into a bloom filter
