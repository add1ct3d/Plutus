...
def process(private_key, public_key, address, database):
    ...
    Average Time: 0.0001054878 seconds
    """
...
def main(database):
    ...
    while True:
        ...
        process(private_key, public_key, address, database) # 0.0001054878 seconds
                                                            # --------------------
                                                            # 0.0033485658 seconds
                                                            # brute forces per second = 0.0033485658 ÷ cpu_count()
...
if __name__ == '__main__':
    ...
    #print('Database Information: ' + repr(database)); quit()
